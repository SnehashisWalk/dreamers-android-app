## The Dreamers App: Privacy policy

Welcome to The Dreamers app for Android!

This is an open source Android app developed by Snehashis Lenka. The source code is available on GitHub under the MIT license; the app is also available on Google Play.
